...
def transcribe_1():
    # Load the Whisper model (you can use a smaller model like "small.en" for faster processing)
    ...
    # Function to generate .srt content with adjusted timestamps for each line
    ...
    # Generate SRT content with shorter lines and adjusted timestamps
    ...
    print("SRT file with correct timestamps and limited words per line has been created: src/subtitles.srt")
